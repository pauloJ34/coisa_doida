...
<html lang="en">
    <head>
        ...
        <title>Laravel</title>
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="{{asset('heroic-features/assets/favicon.ico')}}" />
        <!-- Bootstrap icons-->
        <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.1/font/bootstrap-icons.css" rel="stylesheet" />
        <!-- Core theme CSS (includes Bootstrap)-->
        <link href="{{asset('heroic-features/css/styles.css')}}" rel="stylesheet" />
    ...
    <body>
        ...
        <!-- Core theme JS-->
        <script src="{{asset('heroic-features/js/scripts.js')}}"></script>
    </body>
</html>
